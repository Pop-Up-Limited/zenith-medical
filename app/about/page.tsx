    ...
    <div className="pt-24 pb-20">
      ...
      <div className="container mx-auto px-4 md:px-6 mb-32">
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          ...
          <div className="lg:w-1/2 relative h-[600px] w-full rounded-3xl overflow-hidden shadow-2xl group bg-slate-200">
             <Image
      ...
      <div className="container mx-auto px-4 md:px-6 mb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 h-[600px]">
           <div className="col-span-1 md:col-span-2 row-span-2 relative rounded-2xl overflow-hidden group bg-slate-200">
              <Image 
                src={IMAGES.about.meeting} 
                alt="Meeting" 
                fill 
                priority
                quality={90}
           ...
           <div className="relative rounded-2xl overflow-hidden group bg-slate-200">
              <Image 
                src={IMAGES.innovation.research} 
                alt="Research" 
                fill 
                loading="eager"
                quality={85}
           ...
           <div className="col-span-1 md:col-span-2 relative rounded-2xl overflow-hidden group bg-slate-200">
              <Image 
                src={IMAGES.about.campus1 || IMAGES.about.global} 
                alt="Campus" 
                fill 
                loading="eager"
                quality={85}
