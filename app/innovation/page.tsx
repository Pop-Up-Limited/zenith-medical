    ...
    <div className="pt-24 pb-20">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-32 items-center">
           <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl bg-slate-200">
             <Image 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-32 items-center lg:flex-row-reverse">
           <div className="lg:order-2 relative h-[500px] rounded-3xl overflow-hidden shadow-2xl bg-slate-200">
             <Image 
